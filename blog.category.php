            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 blog_main_box">
                <div class="blog_secondary_box">
                    ...
                    if (isset($_GET['cat'])) {
                        ...
                        $query = "SELECT * FROM posts WHERE category LIKE '$cat'";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $author = $row['author'];
                            $image = $row['image'];
                            $query_1 = "SELECT LEFT(content, 380) FROM posts WHERE author LIKE '$author'";
                            ...
                            ?>
                                <div class="blog_box">
                                    <div class="blog_image">
                                        <a href="category.post.php?page=blog&cat_id=<?php echo $id; ?>" target="_blank"><img src="images/<?php echo $image; ?>"></a>
                                    </div>
                                    <div class="blog_content">
                                        <a href="category.post.php?page=blog&cat_id=<?php echo $id; ?>" target="_blank"><h5>H<?php echo $title; ?></h5></a>
                                        <a href="category.post.php?page=blog&cat_id=<?php echo $id; ?>" target="_blank"><h6>By @ <?php echo $author; ?></h6></a>
